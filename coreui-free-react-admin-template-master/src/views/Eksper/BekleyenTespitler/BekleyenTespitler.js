...
class BekleyenTespitler extends Component {
  ...
  fetchData(){
    fetch('http://localhost:8080/beynhasartespit/findbekleyentespitler')
      ...
      <div className="animated fadeIn">
        <div className="card">
          <div className="card-header">
            <i className="icon-book-open"></i> Bekleyen Tespitler
          </div>
          <div className="card-body">
            <Row>
              <Col md={10}>
                <h2>Bekleyen Tespitlerin Listesi</h2>
              </Col>
              <Col md={2}>
...
export default BekleyenTespitler;
