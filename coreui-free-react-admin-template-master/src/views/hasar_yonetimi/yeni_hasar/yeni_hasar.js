...
import {inputWidth, inputNumberSize, table1} from './yeni_hasar.css';

class yeni_hasar extends Component {
  ...
  postData() {
    fetch(`http://localhost:8080/beynhasartespit/add`, {
      method: 'POST',
      headers: {
  ...
  fetchHasarTespitHesap() {
    ...
    fetch(`http://localhost:8080/beynhasartespithesap/findbyhasartespit?id=${idd}`)
      .then(response => response.json())
      .then(json => {
        console.log(json);
        this.setState({
        ...
        <Modal isOpen={this.state.modalAyrinti} toggle={this.toggleModalAyrinti} className="modal-lg">
          ...
          <ModalBody>
            <Row>
              ...
              <select id="hesapUpdateEksperTakdiri" disabled={this.state.hesapDetay.ekspertakdiri === 0} className="form-control"
              ...
              <input id="hesapUpdateIzahat" className="form-control" type="text" defaultValue={this.state.hesapDetay.izahat}/> </Col>
              <input id="hesapUpdateTespitid" disabled={true} hidden={true} value={this.state.hesapDetay.beynhasartespit_id}/>
              <input id="hesapUpdateGrupid" disabled={true} hidden={true} value={this.state.hesapDetay.beynhesapgrubu_id}/>
              <input id="hesapUpdateTuruid" disabled={true} hidden={true} value={this.state.hesapDetay.beynhesapturu_id}/>
          ...
          <ModalFooter>
            <Button color="primary" onClick={() => this.beynHasarTespitGuncelle(this.state.hesapDetay.id,rayicDegeri)}>Kaydet</Button>{' '}
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        <Row>
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="dosyaNumarasiRef" type="text" onChange={this.handleClick.bind(this)}/>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Dosya Yılı:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="dosyaYiliRef" type="text" onChange={this.handleClick.bind(this)}/>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Araç Plakası:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="tespitPlakaRef" type="text" onChange={this.handleClick.bind(this)}/>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Olay Yeri:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="hasarYeriRef" type="text" onChange={this.handleClick.bind(this)}/>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Olay Tarihi:
                          ...
                          <Col md={10}>
                            <input className="form-control" type="date" ref="hasarTarihiRef" onChange={this.handleClick.bind(this)}/>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Eksperler:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="hasarNedeniRef" onChange={this.handleClick.bind(this)}
                                   type="text"/> {/* value={this.state.data.hasarNedeni} */}
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Hasar Kusur Tespiti:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="hasarKusurSekliRef"
                                   onChange={this.handleClick.bind(this)}
                                   type="text"/> {/* value={this.state.data.hasarKusurSekli} */}
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            İzahat:
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="izahatRef" onChange={this.handleClick.bind(this)}
                                   type="text"/> {/* value={this.state.data.izahat} */}
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Tramer No:
                          ...
                          <Col md={10}>
                            <select className="form-control" ref="beynAracMarkaTespitRef"
                                    onChange={this.handleClick.bind(this)}>
                              {markalar.map(marka => <option value={marka.id}>{marka.tanim}</option>)}
                            </select>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                          ...
                          <Col md={10}>
                            <select className="form-control" ref="beynAracRengiTespitRef"
                                    onChange={this.handleClick.bind(this)}>
                              {renkler.map(renk => <option value={renk.id}>{renk.tanim}</option>)}
                            </select>
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                          ...
                          <Col md={10}>
                            <input className="form-control" ref="hasarPlakaRef" onChange={this.handleClick.bind(this)}
                                   type="text"/> {/* value={this.state.data.hasarPlaka} */}
                          </Col>
                          <Col md={12}><br/></Col>
                          <Col md={2}>
                            Motor No:
